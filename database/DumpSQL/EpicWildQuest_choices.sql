...
CREATE TABLE `choices` (
  ...
  KEY `fk_choices_stories1_idx` (`stories_id`),
  CONSTRAINT `fk_choices_stories1` FOREIGN KEY (`stories_id`) REFERENCES `stories` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
